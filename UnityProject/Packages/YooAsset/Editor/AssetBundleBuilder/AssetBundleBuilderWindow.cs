...
namespace YooAsset.Editor
{
    public class AssetBundleBuilderWindow : EditorWindow
    {
        ...
        public static AssetBundleBuilderWindow OpenWindow()
        {
        ...
        public void CreateGUI()
        {
            try
            {
                ...
                _buildVersionField.SetValueWithoutNotify(!string.IsNullOrEmpty(version) ? version : version = GetBuildPackageVersion());
        ...
        public void ChangeVersion(string evt)
        {
            _buildVersionField.SetValueWithoutNotify(version = evt);
        }
