...
namespace TEngine.Runtime
{
    ...
    [AddComponentMenu("TEngine/Procedure")]
    public sealed class ProcedureComponent : UnitySingleton<ProcedureComponent>
    {
        ...
        private IEnumerator Start()
        {
            ...
            m_ProcedureManager.Initialize(FsmManager.Instance, procedures);
